...
{
    public static string luaDir = AppConst.FrameworkRoot + "/Lua";//  Application.dataPath + "/LuaFramework/Lua";
    public static string toluaDir = AppConst.FrameworkRoot + "/ToLua/Lua";//Application.dataPath + "/LuaFramework/ToLua/Lua";
