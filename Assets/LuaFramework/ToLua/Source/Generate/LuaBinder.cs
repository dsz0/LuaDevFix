...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		LuaFramework_RazByteBufferWrap.Register(L);
		LuaFramework_RazConverterWrap.Register(L);
		LuaFramework_LuaBehaviourWrap.Register(L);
		LuaFramework_HotFixManagerWrap.Register(L);
		...
		LuaFramework_RazNetworkManagerWrap.Register(L);
		LuaFramework_LuaResourceManagerWrap.Register(L);
		L.EndModule();
