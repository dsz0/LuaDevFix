...
class "List" (function (_ENV)
    ...
    -- Meta-method
    -----------------------
    __DebugArguments__{ NegtiveInteger }
...
class "ListStreamWorker" (function (_ENV)
    ...
    __DebugArguments__{ Argument(Integer, true, 1), Argument(Integer, true, -1), Argument(Integer, true, 1) }
    function Range(self, start, stop, step)
        if start == nil then start = 1 end -- SetDefaultValue
        if stop == nil then stop = -1 end -- SetDefaultValue
        if step == nil then step = 1 end -- SetDefaultValue
...
interface "IList" (function (_ENV)
    ...
    function Range(self, start, stop, step) 
        ...
        if stop == nil then stop = -1 end -- SetDefaultValue
        if step == nil then step = 1 end -- SetDefaultValue
        return ListStreamWorker.GetWorker(self):Range(start, stop, step) 
    end
    ...
    __DebugArguments__{ Argument(-IList, true, List) }
    function ToList(self, cls) 
        if cls == nil then cls = List end -- SetDefaultValue
        return cls(self) 
    end

    __Doc__[[Combine the items to get a result]]
    __DebugArguments__{ Callable, Argument(Any, true) }
    ...
    __DebugArguments__{ Callable, Argument(Any, true, nil, nil, true) }
    ...
    __DebugArguments__{ Callable, Argument(System.Any, true, nil, nil, true) }
