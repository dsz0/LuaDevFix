...
__DebugArguments__{ Argument(Integer, true, 1), Argument(Integer, true, -1) }
...
__DebugArguments__{ Argument(Callable, true, "x,y=>x<y"), Argument(Integer, true, 1), Argument(Integer, true, -1) }
function IIndexedList:InsertionSort(compare, start, stop)
    if compare == nil then compare = "x,y=>x<y" end -- SetDefaultValue
    if start == nil then start = 1 end -- SetDefaultValue
    if stop == nil then stop = -1 end -- SetDefaultValue
...
function IIndexedList:Sort(func, start, stop)
    if func == nil then func = "x,y=>x<y" end -- SetDefaultValue
    if start == nil then start = 1 end -- SetDefaultValue
    if stop == nil then stop = -1 end -- SetDefaultValue
