...
--======================================================================
-- filename: game.lua
-- author: lorry  created: 2018/02/21
-- descrip: 游戏入口，持有大部分的管理类(除了gControl在start.lua中处理)
-- CUIMgr，实现界面简单管理，并提供通用界面调用，比如MsgBox,还有Tips，跑马灯等等。
-- CSceneManager，主要是切换场景后，需要显示的界面不一样，界面显示逻辑由Scene控制。
-- CDataManager,所有数据的提供者，一部分通过本地读取，一部分
-- CGuideManager，新手引导管理器，非常重要的管理器，任何游戏都需要。
--======================================================================
